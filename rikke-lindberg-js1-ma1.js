...
add it to a variable you declare before the loop and return the variable from 
the function after the loop.*/
function catName(catArray) {
  let catHTML = "";
...
const catHTML = catName(cats);

resultsContainer.innerText = catHTML;

/*Question 10
Using the function from question 8, 
